...
public enum Clock {
    ...
    public static func timestamp16() -> UInt16 {
        return timestamp16(fromMillis: nowMillis())
    }

    public static func diff16(new: UInt16, old: UInt16) -> UInt16 {
        return new &- old
    }

    public static func timestamp16(fromMillis millis: UInt64) -> UInt16 {
